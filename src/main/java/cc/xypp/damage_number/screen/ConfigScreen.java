...
public class ConfigScreen extends Screen {
    ...
    public ConfigScreen() {
        ...
        super(Component.translatable("damage_number:config.title"));
    ...
    protected void init() {
        ...
        this.addRenderableWidget(row.addChild(new StringWidget(Component.translatable("damage_number:config.x"), this.font)));
        xEditBox = this.addRenderableWidget(row.addChild(new EditBox(this.font, 0, 0, CONFIG_PANE_WIDTH, BUTTON_HEIGHT, Component.literal("x"))));
        this.addRenderableWidget(row.addChild(new StringWidget(Component.translatable("damage_number:config.y"), this.font)));
        yEditBox = this.addRenderableWidget(row.addChild(new EditBox(this.font, 0, 0, CONFIG_PANE_WIDTH, BUTTON_HEIGHT, Component.literal("y"))));
        this.addRenderableWidget(row.addChild(new StringWidget(Component.translatable("damage_number:config.opacity"), this.font)));
        opacityEditBox = this.addRenderableWidget(row.addChild(new EditBox(this.font, 0, 0, CONFIG_PANE_WIDTH, BUTTON_HEIGHT, Component.literal("opacity"))));
        this.addRenderableWidget(row.addChild(new StringWidget(Component.translatable("damage_number:config.scale"), this.font)));
        scaleEditBox = this.addRenderableWidget(row.addChild(new EditBox(this.font, 0, 0, CONFIG_PANE_WIDTH, BUTTON_HEIGHT, Component.literal("scale"))));
        this.addRenderableWidget(row.addChild(new StringWidget(Component.literal(""), this.font)));
        selectKey = this.addRenderableWidget(row.addChild(
                new CycleButton.Builder<Component>(this::changeKey)
                        ...
                        .create(0, 0, CONFIG_PANE_WIDTH, BUTTON_HEIGHT, Component.translatable("damage_number:config.select_key"))
        ));
        maxSizeEditBoxLabel = this.addRenderableWidget(row.addChild(new StringWidget(Component.translatable("damage_number:config.max_size"), this.font)));
        maxSizeEditBox = this.addRenderableWidget(row.addChild(new EditBox(this.font, 0, 0, CONFIG_PANE_WIDTH, BUTTON_HEIGHT, Component.literal("scale"))));
    ...
    public void render(@NotNull GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        render.render(pGuiGraphics, this.font, pPartialTick, this.width, this.height, true);
    }
